...
def handle_message(event):
    ...
    get_cookie = requests.get(url_get,data=get_data,headers=get_headers,proxies={'https':'https://cache.sinica.edu.tw:3128'})
...
#    service-site-url = soup_get.find(id='service-site-url')['value']
    ...
    resp = requests.post(url_post,headers=headers,data=data,proxies={'https':'https://cache.sinica.edu.tw:3128'})
